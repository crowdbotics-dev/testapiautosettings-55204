...
## Project Structure
    ...
    ├── testapiautosettings_55204  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_55204`
...
2. Clone this repo and `cd testapiautosettings_55204`
